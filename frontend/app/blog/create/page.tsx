                    ...
                    >
                        ...
                        >
                            <motion.button
                                ...
                                className="px-6 py-3 border-2 border-blue-500 rounded-lg text-gray-700 hover:bg-gradient-to-r hover:from-blue-50 hover:to-purple-50 font-medium transition-all"
